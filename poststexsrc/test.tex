...
This is a sample math document. Let's present the definition of a limit:
\[
  \lim_{n \to \infty} x_n = L \iff \forall \varepsilon > 0, \exists N \in
  \mathbb{N}, \forall n \geq N, d(L, x_n) < \varepsilon
\]
