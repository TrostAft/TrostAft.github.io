...
\item
    ...
    Computer Science (In Major GPA: 3.596)}{Sep. 2016 - Present}
	\begin{itemize}
        \resitem{Intending to do B.A./M.A. program at NYU to complete in 2020.
        This is why I'm applying to Master's in progress required positions.}
		...
		\resitem{Relevant graduate/PhD courses: Fundamental Algorithms,
		Numerical Methods I, Algebra, Partial Differential Equations,
		Geometric Modeling}
	\end{itemize}
...
\item[Membership:] Student member of ACM and in the EBoard of the ACM Chapter of
NYU.
