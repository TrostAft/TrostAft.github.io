...
Laurel, MD & \url{https://abhijit-c.github.io/}\\
\end{tabular*}
\\
...
\begin{itemize}
\item
	\ressubheading{North Carolina State University}{Raleigh, NC}{Applied Math PhD,
  Computational Math Concentration}{Aug. 2020 - Present}
  \begin{itemize}
    \resitem{Recipient of the Siewert Fellowship (Aug. 2020 - May 2021).}
  \end{itemize}
...
OpenMP, MPI, HPC Tooling (slurm, etc.), CUDA and ROCm (learning)
\item[Languages:]
English, Latin, Somewhat broken Hindi
